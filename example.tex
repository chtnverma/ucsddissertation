...
The past two decades have witnessed a tremendous growth in the amount of information available to users~\cite{NEEDED}~\cite{NEEDED}~\cite{NEEDED}. Often called "Information explosion"~\cite{}, this trend has reflected across multiple ecosystems including Web based sharing systems, social networks and enterprise systems, as well as across different types of the data including videos, images, documents, audio files, tweets etc. For example, online video traffic /viewership has risen from VVVV in 20YY to BBBB in 20TT~\cite{}. Enterprise data has been growing at a rate of ZZ times per year~\cite{}. The online image sharing website Flickr~\cite{} alone boasts of more than XX images~\cite{}. While the growing size of the available data provides valuable resource to users, its sheer size limits its usability and hence value. Users find it challenging to obtain useful or interesting information from the deluge of available data, an issue commonly referred to as Information Overload~\cite{}\cite{}. 
